-- Fix Phase D-1 — ajoute 'daily_catalyst_brief' à la contrainte CHECK
-- sur lisa_decision_log.kind. Sans ça, la PR #401 (fix brief persist)
-- était logique mais bloquée par la contrainte DB → count=0 silencieux.
--
-- Idempotent : DROP IF EXISTS + recréation avec liste complète + nouvelle clé.

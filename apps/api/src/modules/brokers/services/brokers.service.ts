...
export class BrokersService {
  ...
  private adapterFlags() {
    return {
      ...
      BROKER_ADAPTER_BINANCE_ENABLED: this.flags.isEnabled('BROKER_ADAPTER_BINANCE_ENABLED'),
      BROKER_EXECUTION_ENABLED: this.flags.isEnabled('BROKER_EXECUTION_ENABLED'),
    };
  }

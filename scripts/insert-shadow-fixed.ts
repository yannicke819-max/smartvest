...
const portfolios = [
  { id: 'a0000001-0000-0000-0000-000000000001', name: 'high',   max: 3,  pct: 33.33, perCycle: 1 },
  { id: 'a0000002-0000-0000-0000-000000000002', name: 'middle', max: 15, pct: 6.67,  perCycle: 4 },
  { id: 'a0000003-0000-0000-0000-000000000003', name: 'small',  max: 20, pct: 5,     perCycle: 8 },  // cap 20
];
...
(async () => {
  for (const p of portfolios) {
    ...
    console.log(`${p.name} (${p.id}): ${error ? 'ERROR ' + error.message : 'OK'}`);
  }
  // Verify
